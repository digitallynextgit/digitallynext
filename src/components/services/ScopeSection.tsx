...
export default function ScopeSection({ section, theme }: Props) {
  ...
  return (
    <>
      <section className={['transition-colors duration-700', isDark ? 'bg-[#000000]' : 'bg-[#FAFAFA]'].join(' ')}>
            ...
            <div>
                    ...
                    >
                      ...
                      >
                        ...
                        <span
                          ...
                          style={{
                            color:
                              activeIndex === idx ? theme.accent : isDark ? 'rgba(255,255,255,0.3)' : 'rgba(0,0,0,0.3)',
                          }}
                        >
              ...
              <div className="flex flex-col lg:hidden">
                {section.items.map((item, idx) => (
                  <div key={idx}>
                    <div
                      className={['flex flex-col gap-6', idx < section.items.length - 1 ? 'pb-18' : 'pb-14'].join(' ')}
                    >
                      {item.imageSrc && (
