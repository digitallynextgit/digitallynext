...
export default function Preloader() {
  ...
  useEffect(() => {
    // iOS Safari fix: lock both html AND body to prevent scroll during preloader
    document.body.style.overflow = 'hidden';
    document.documentElement.style.overflow = 'hidden';
    // iOS Safari also needs touch-action disabled on body
            ...
            >
              ...
              <motion.span
                style={{
                  ...
                  userSelect: 'none',
                  whiteSpace: 'nowrap',
                  // Framer Motion auto-prefixes clipPath to -webkit-clip-path in Safari
