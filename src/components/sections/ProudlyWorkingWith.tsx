    ...
    <section className={`pt-10 md:pt-16 lg:pt-20 overflow-hidden ${isDark ? 'bg-black' : 'bg-[#F5F5F5]'}`}>
        ...
        <div className="flex flex-col items-center mb-12 md:mb-16 lg:mb-20">
          ...
          >
            ...
            >
              ...
              <span className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-[80px]">working with</span>
      ...
      >
        <div className="max-w-6xl mx-auto px-4">
          <WorldMap dots={mapDots} lineColor="#0EC8C5" theme={isDark ? 'dark' : 'light'} />
        </div>
      </div>
    </section>
  );
