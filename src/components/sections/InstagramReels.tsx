      ...
      <div className="max-w-7xl mx-auto px-5 md:px-12">
        ...
        >
          {INSTAGRAM_REELS.map((reel, index) => (
            ...
            >
              <div className="relative w-full aspect-9/16 rounded overflow-hidden border border-gray-200 bg-gray-50 hover:border-gray-400 transition-all duration-500 hover:shadow-lg">
                <iframe
                  src={reel.embedUrl}
        ...
        >
          <Link
            ...
            className="inline-flex items-center gap-3 px-6 py-3 lg:px-8 lg:py-4 rounded-full border border-gray-300 text-[#1a1a1a] font-semibold text-sm tracking-wide hover:border-[#E53935] hover:text-[#E53935] transition-all duration-300 group no-underline"
          >
            <svg
