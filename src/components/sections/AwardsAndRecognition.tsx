...
export default function AwardsAndRecognition({ theme }: AwardsAndRecognitionProps) {
  ...
  return (
    <section ref={sectionRef} className="py-8 sm:py-10 md:py-16 lg:py-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center gap-8 sm:gap-10 md:gap-14 lg:gap-18">
          ...
          >
            ...
            <span className="text-[#0EC8C5] text-3xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-[80px]">.</span>
          </motion.h2>
