...
export default function HowWeOperate({ theme }: HowWeOperateProps) {
  ...
  return (
    <section id="how-we-operate" className="w-full flex flex-col items-center py-10 md:py-16 lg:py-20">
      {/* Modern DAD Heading */}
            ...
            <AnimatedSection key={pillar.word} delay={0.15 + i * 0.1}>
              <div className="flex flex-col items-center gap-4">
                <div className="relative w-[clamp(120px,15vw,200px)] h-[clamp(120px,15vw,200px)]">
                  <Image
                    src={
                      i === 0 ? '/home/moderndad1.webp' : i === 1 ? '/home/moderndad2.webp' : '/home/moderndad3.webp'
                    }
                    alt={pillar.word}
                    fill
                ...
                <p className="text-center max-w-45 lg:max-w-47.5 xl:max-w-56.75 leading-[1.4]">
                  <span className="text-[#E53935] font-bold text-[clamp(1.1rem,1.5vw,1.4rem)]">{pillar.word}</span>{' '}
                  <span
                    className={[
        ...
        <AnimatedSection delay={0.5}>
          <div className="px-4">
            ...
            >
              ...
              >
                Decide with data. <span>Move with intelligence.</span> <strong>Build digitally.</strong>
              </p>
            </div>
          </div>
        </AnimatedSection>
