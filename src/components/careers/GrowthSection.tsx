...
export default function GrowthSection({ theme }: GrowthSectionProps) {
  ...
  return (
    <section className={['w-full transition-colors duration-700', isDark ? 'bg-black' : 'bg-white'].join(' ')}>
      <div
      ...
      <div className="w-full max-w-7xl mx-auto px-6 lg:px-10 py-10 md:py-16 lg:py-20">
        ...
        >
          How <span className="text-[#E21F26] font-semibold">Growth</span> Actually Happens
          ...
          {items.map(({ num, title, desc, borderBottom }) => (
            <div
              ...
              className={[
                ...
                borderBottom ? (isDark ? 'border-b border-[#2a2a2a]' : 'border-b border-[#E5E5E5]') : '',
              ].join(' ')}
            >
              <div
                className={[
              ...
              >
                ...
                <div
                  className={[
                    ...
                    isDark ? 'text-[#3a3a3a] group-hover:text-[#737373]' : 'text-[#D4D4D4] group-hover:text-[#A1A1A1]',
                  ].join(' ')}
                >
                  {num}
                </div>
                ...
                <div
                  className={[
                    ...
                    isDark ? 'text-[#737373] group-hover:text-[#A1A1A1]' : 'text-[#A1A1A1] group-hover:text-[#737373]',
                  ].join(' ')}
                >
                  {desc}
                </div>
