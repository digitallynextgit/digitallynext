...
export default function WhoThrivesSection({ theme }: WhoThrivesSectionProps) {
  ...
  return (
    <section className="relative w-full overflow-hidden">
      ...
      {/* Dark overlay */}
      <div className="absolute inset-0 z-10" style={{ background: 'rgba(0,0,0,0.90)' }} />
      ...
      <div className="relative z-20 w-full">
        <div className="w-full max-w-7xl mx-auto px-6 lg:px-10 py-12 md:py-16 lg:py-20 text-white">
          ...
          <div className="text-center max-w-180 mx-auto">
            <h2 className="font-normal leading-[1.15] text-white" style={{ fontSize: 'clamp(1.75rem, 4vw, 2.975rem)' }}>
              Who Thrives at <span className="text-[#E21F26] font-bold">Digitally</span>{' '}
              <span className="font-bold text-white">Next</span>
              <span className="text-[#0EC8C5] font-bold">.</span>
            </h2>
            <p className="mt-6 text-[#D1D1D1] font-light text-[16px] leading-[1.8]">People who do well here usually:</p>
          </div>
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      opacity: hoveredIndex === null || hoveredIndex === traitIdx ? 1 : 0.35,
                    }}
                  >
                    <div
