...
export default function CareersCtaSection({ theme }: CareersCtaSectionProps) {
  ...
  return (
    <section className="relative overflow-hidden" style={{ height: 'clamp(500px, 80vh, 790px)' }}>
      {/* Background image */}
      <Image
        src="/figma/careers/careers-team.webp"
        alt="Digitally Next team at work"
        fill
        priority
        sizes="100vw"
      ...
      <div className="relative z-1 w-full h-full flex flex-col items-center justify-center text-center px-6 py-19 gap-12">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="font-normal leading-[1.1] text-white" style={{ fontSize: 'clamp(2rem, 5vw, 4rem)' }}>
            Systems that scale.
          </div>
          <div className="font-bold leading-[1.1] text-white" style={{ fontSize: 'clamp(2rem, 5vw, 4rem)' }}>
