    ...
    <section className="w-full py-10 md:py-0 lg:py-0 md:pt-16 lg:pt-20">
      <div className="mx-auto w-full max-w-[1280px] px-4 flex flex-col items-center gap-4 md:gap-[16px]">
        <div className="max-w-[1280px] w-full grid grid-cols-1 lg:grid-cols-[minmax(0,844px)_1fr] gap-4 md:gap-[16px]">
          ...
          <div className={isLight ? "rounded-[10px] bg-gray-100 p-6 md:p-[34px_28px]" : "rounded-[10px] bg-[#111111] p-6 md:p-[34px_28px]"}>
            <div className="h-full flex flex-col justify-between min-h-[270px]">
              ...
              <div className={isLight ? "text-[14px] md:text-[16px] leading-normal md:leading-[1.3] font-normal text-black capitalize" : "text-[14px] md:text-[16px] leading-normal md:leading-[1.3] font-normal text-white capitalize"}>
                {first?.description ?? ""}
              </div>
            </div>
          </div>
        ...
        <div className={`w-full grid grid-cols-1 ${restGridClass} gap-4 md:gap-[16px]`}>
          {rest.map((c) => (
            <div key={c.title} className={isLight ? "rounded-[10px] bg-gray-100 p-6 md:p-[34px_28px]" : "rounded-[10px] bg-[#111111] p-6 md:p-[34px_28px]"}>
