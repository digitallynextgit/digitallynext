      ...
      <div className="w-full px-4 sm:px-6 md:px-[59px] py-10 relative">
        <div className="w-full flex flex-col lg:flex-row gap-10 lg:gap-[142px] justify-center">
          <div className="w-full max-w-[463px] flex flex-col gap-6 md:gap-[54px]">
            <div className={isLight ? " text-center md:text-start text-[44px] sm:text-[56px] md:text-[80px] leading-[1.1] md:leading-[1.3] font-normal text-black" : "text-[44px] sm:text-[56px] md:text-[80px] leading-[1.1] md:leading-[1.3] font-normal text-white text-center md:text-start "}>
