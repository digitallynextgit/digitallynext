...
export const metadata: Metadata = {
  ...
  description:
    'Partner with Digitally Next for strategy, branding, performance marketing, content creation, web development, and AI-driven decisions. We transform brands into digital powerhouses.',
  openGraph: {
    title: 'Digitally Next | Growth-Driven Global Digital Marketing Agency',
    description:
