    ...
    <div className="mt-20" style={{ background: 'var(--bg-primary)', minHeight: '100vh' }}>
      ...
      <section className="container section" style={{ paddingTop: 24 }}>
        {filteredPosts.length === 0 ? (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="blog-empty">
            <p style={{ fontSize: 64, marginBottom: 16, lineHeight: 1 }}>📝</p>
            <h3 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No posts yet</h3>
              ...
              >
                <Link href={`/blog/${post.slug.current}`} className="blog-card">
                  ...
                  <div className="blog-card-image-wrapper">
                    ...
                    {/* Category badge */}
                    {post.categories?.[0] && <span className="blog-card-category">{post.categories[0].title}</span>}
                  </div>
