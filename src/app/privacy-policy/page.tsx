    ...
    <main>
        ...
        <div className="w-[92%] sm:w-[90%] max-w-5xl mx-auto">
          <div className="space-y-6">
            ...
            <p className={['text-sm sm:text-base md:text-lg max-w-3xl leading-relaxed', mutedClass].join(' ')}>
              Empowering businesses with next-generation digital solutions and innovative strategies. We collect and use
      ...
      <section className="pb-20 md:pb-28">
        <div className="w-[92%] sm:w-[90%] max-w-5xl mx-auto space-y-6">
          ...
          {/* Data Protection */}
          <div className={cardClass}>
            <h2 className={['text-2xl sm:text-3xl font-bold mb-3', headingClass].join(' ')}>Data Protection</h2>
          ...
          {/* Your Rights */}
          <div className={cardClass}>
            <h2 className={['text-2xl sm:text-3xl font-bold mb-4', headingClass].join(' ')}>Your Rights</h2>
            <ul className={['list-disc pl-5 space-y-2 text-sm sm:text-base leading-relaxed', mutedClass].join(' ')}>
