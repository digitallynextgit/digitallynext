...
function TermsContent() {
  ...
  const headingClass = ['transition-colors duration-500', isDark ? 'text-white' : 'text-[#1a1a1a]'].join(' ');

  const mutedClass = ['transition-colors duration-500', isDark ? 'text-white/70' : 'text-black/60'].join(' ');
        ...
        <div className="w-[92%] sm:w-[90%] max-w-5xl mx-auto">
          <div className="space-y-6">
            ...
            <p className={['text-sm sm:text-base md:text-lg max-w-3xl leading-relaxed', mutedClass].join(' ')}>
              Empowering businesses with next-generation digital solutions and innovative strategies. By using our
              website and services, you agree to these terms. Please read them carefully.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="pb-20 md:pb-28">
        <div className="w-[92%] sm:w-[90%] max-w-5xl mx-auto space-y-6">
          ...
          <div className={cardClass}>
            <h2 className={['text-2xl sm:text-3xl font-bold mb-3', headingClass].join(' ')}>Agreement</h2>
          ...
          {/* Usage Rules */}
          <div className={cardClass}>
            <h2 className={['text-2xl sm:text-3xl font-bold mb-4', headingClass].join(' ')}>Usage Rules</h2>
          ...
          {/* Liability */}
          <div className={cardClass}>
            <h2 className={['text-2xl sm:text-3xl font-bold mb-3', headingClass].join(' ')}>Liability</h2>
            <p className={['text-sm sm:text-base leading-relaxed', mutedClass].join(' ')}>
          ...
          {/* Contact */}
          <div className={cardClass}>
            <h2 className={['text-2xl sm:text-3xl font-bold mb-4', headingClass].join(' ')}>Contact</h2>
            <div className={['grid grid-cols-1 md:grid-cols-2 gap-6 text-sm sm:text-base', mutedClass].join(' ')}>
              <div className="space-y-2">
                ...
                <p className={['pt-2', isDark ? 'text-white/60' : 'text-black/50'].join(' ')}>General inquiries</p>
                <Link
