...
export const clientLogos = ['Signia', 'SensuQ', 'Gajna', 'Khaleej', 'House of Nandini', 'ADAC'];
...
export const insights = [
  ...
  },
  {
    ...
    excerpt: 'Our proprietary framework that transforms how brands make decisions and execute campaigns at scale.',
    date: 'Jan 28, 2025',
  ...
  },
  {
    ...
    excerpt: 'Why vanity metrics are killing your ROI and how to build measurement frameworks that actually matter.',
    date: 'Jan 15, 2025',
