...
export const services: ServiceDetail[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      ...
      overlay: 'linear-gradient(180deg, rgba(0,0,0,0.65) 0%, rgba(226,31,38,0.88) 100%)',
    ...
    yourAsk: {
      ...
      description: 'Then Strategy, Brand & Growth Intelligence at DigitallyNext is built for you.',
    ...
    sections: [
      {
        ...
        list: [
          ...
          {
            accent: 'alt',
            text: 'Sharp <strong>positioning</strong> that doesn\u2019t<br> collapse under competition',
          },
      ...
      },
      {
        ...
        footerText: 'So that every action that follows is intentional, aligned, and scalable.',
      },
      {
        type: 'scope',
        eyebrow: 'Scope',
        heading: 'What this includes<span style="color:#0EC8C5">.</span>',
        description: 'Depending on the business model and stage, this typically spans:',
        items: [
          {
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      ...
      overlay: 'linear-gradient(180deg, rgba(0,0,0,0.65) 0%, rgba(14,200,197,0.85) 100%)',
      subtitle: 'Where stories are crafted to endure platforms and trends',
      quoteLead: 'We often see brands say things like this',
      quoteText: '\u201cWe need content, but not just posts \u2014 a real content strategy.\u201d',
      quoteColor: '#000',
      body: [
    ...
    yourAsk: {
      ...
      description: 'Then Content, Culture & Media Creation at Digitally Next is built for you.',
      ctaLabel: 'Get In Touch',
      ctaHref: '/contact',
      arrowSrc: '/figma/services/arrow1.svg',
    },
    sections: [
      {
        ...
        list: [
          {
            accent: 'accent',
            text: 'Content is <strong>created faster</strong> than<br> it\u2019s being thought through',
          },
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      ...
      quoteLead: 'We often see brands say things like this',
      quoteText: '\u201cLooking for a reliable website development partner \u2014 not just a one-time build.\u201d',
      quoteColor: '#000',
      body: [
    ...
    yourAsk: {
      ...
      description: 'Then Platforms, Web & Digital Experience at Digitally Next is built for you.',
      ctaLabel: 'Get In Touch',
      ctaHref: '/contact',
      arrowSrc: '/figma/services/arrow1.svg',
    },
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      ...
      subtitle: '',
      quoteLead: 'We often see brands say things like this',
      quoteText: '\u201cEveryone is using AI \u2014 but outputs are starting to look the same.\u201d',
      quoteColor: '#1BB9B4',
      body: [
    ...
    sections: [
      {
        ...
        eyebrow: 'The Real Brief',
        heading: 'What brands are actually asking for',
        description: 'Across branding, content, performance, and platforms, the pattern is clear:',
        list: [
        ...
        cards: [
          {
            ...
            description: 'Evaluate where AI genuinely adds value, applying it intentionally rather than by default.',
          },
          {
            iconSrc: '/services/icon2.png',
