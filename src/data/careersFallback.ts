...
//
// Snapshot of the published DNMS careers tree, taken 2026-07-16.
// Full-time: 5 groups / 17 roles.
// Internship: 1 groups / 7 roles.
//
...
export const CAREERS_FALLBACK_CAPTURED_AT = '2026-07-16';
...
const FULL_TIME = [
  {
    ...
    subDepartments: [
      ...
      {
        id: 'msg-marketing-services-group',
        title: 'MSG - Marketing Services Group',
        jobsLabel: 'Explore Open Roles',
        tone: 'red',
        roles: [
          {
            id: 'content-writers-copywriters',
          ...
          {
            id: 'smo-social-media-optimisation-linkedin-meta-x-youtube',
          ...
          {
            id: 'pr-and-communications-executive',
  ...
  },
  {
    ...
    subDepartments: [
      {
        id: 'pmg-project-management-group',
  ...
  },
  {
    ...
    subDepartments: [
      {
        id: 'wem-web-essentials-management',
      ...
      {
        id: 'vim-visual-impact-management',
        ...
        roles: [
          ...
          {
            id: 'video-editors-motion-graphic-artists',
          ...
          {
            id: 'graphic-designers-ui-ux-designers',
...
] satisfies CareersDepartmentGroup[];
